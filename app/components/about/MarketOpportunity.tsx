      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            This shift is not abstract—it&apos;s measurable, and the growth
            opportunity is substantial. Ghana represents an untapped and
            underserved market for affordable, integrated data + digital
            bundles.
          </p>
        </div>
